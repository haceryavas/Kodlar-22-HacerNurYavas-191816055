...
public class IslemlerEkrani extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kitap_egs.setBackground(new java.awt.Color(249, 220, 166));
        ...
        kitap_listele.setBackground(new java.awt.Color(249, 220, 166));
        ...
        odunc_kitap_listele.setBackground(new java.awt.Color(249, 220, 166));
        ...
        kitap_ver.setBackground(new java.awt.Color(249, 220, 166));
        ...
        kitap_al.setBackground(new java.awt.Color(249, 220, 166));
        ...
        uye_egs.setBackground(new java.awt.Color(249, 220, 166));
        ...
        uye_listele.setBackground(new java.awt.Color(249, 220, 166));
        ...
        uye_borc_sil.setBackground(new java.awt.Color(249, 220, 166));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/hacernur/arayuz/kitap.png"))); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/hacernur/arayuz/uye.png"))); // NOI18N
        ...
        yonetici_islemleri.setBackground(new java.awt.Color(255, 153, 0));
        yonetici_islemleri.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        yonetici_islemleri.setForeground(new java.awt.Color(249, 220, 166));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IslemlerEkrani.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
