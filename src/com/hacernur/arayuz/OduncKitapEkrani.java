...
import com.hacernur.database.OduncKitapIslemleri;
...
public class OduncKitapEkrani extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/hacernur/arayuz/kitap ara.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OduncKitapEkrani.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
